...
public enum Lang {
	...
	TOKENS_RUNE_ALREADY_ACTIVE("tokens.runes.already-active", "&7You already have active rune! Wait befores it expires to use another!"),
	TOKENS_RUNE_APPLY("tokens.runes.apply", "&7You've successfully used rune &c%s!"),
	TOKENS_RUNE_EXPIRE("tokens.runes.expire", "&7Your rune &c%s &7has ended!"),
	TOKENS_RUNE_COOLDOWN("tokens.runes.cooldown", "&7You can use another rune in %d!"),
	TOKENS_FROZEN("tokens.runes.frozen", "&7You have been frozen by &c%s&7!"),
	TOKENS_LIGHTNING("tokens.runes.lightning", "&7You have been with lightning by &c%s&7!"),
